...
set output "cmp_perf_all_big.pdf"
...
# MA87 | OpenMP | StarPU| Parsec
plot 'cn255/data_cmp_perf_big.dat' using ($0+1):3 ls 1 w lp t 'HSL_MA87', \
     ''                        using ($0+1):5 ls 2 w lp t 'SpLLT (OpenMP)', \
     ''                        using ($0+1):7 ls 3 w lp t 'SpLLT (StarPU)', \
     ''                        using ($0+1):9 ls 4 w lp t 'SpLLT (PaRSEC)', \
     768 ls 5 title "DGEMM"
...
# STF and PTG (perf GFlop/s) all
# MA87 | OpenMP | StarPU| Parsec
# plot 'cn255/data_cmp_perf.dat' using ($0+1):3 ls 1 w lp t 'HSL_MA87', \
#      ''                        using ($0+1):5 ls 2 w lp t 'SpLLT-STF (OpenMP)', \
#      ''                        using ($0+1):7 ls 3 w lp t 'SpLLT-STF (StarPU)', \
#      ''                        using ($0+1):9 ls 4 w lp t 'SpLLT-PTG (PaRSEC)'#, \
#      # 768 ls 5 title "Practical machine peak (DGEMM)"
