...
module spllt_utils_mod
  ...
  interface spllt_sort
     module procedure spllt_sorti, spllt_sortl
  end interface spllt_sort
...
contains
  ...
  !
  subroutine spllt_sortl( array, n, map, val )
  ...
  !   Sort an integer array by heapsort into ascending order.
  !
  subroutine spllt_sorti( array, n, map, val )
    integer, intent(in) :: n       ! Size of array to be sorted
