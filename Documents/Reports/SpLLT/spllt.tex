...
This parallel programming model, however, has several drawbacks that
may affect the performance and scalability of parallel codes. First
the task are issued and submitted to the runtime system
sequentially. In the case where the task granularity is small compared
to the time needed for building and submitting a task, the parallel
execution might be constraint by the time spent in the submission
loop.
