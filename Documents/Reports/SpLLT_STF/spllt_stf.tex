...
processor have become increasingly popular and can be found in the
vast majority of high performance computing platforms. Despite their
popularity, exploiting the capabilities of multicore processors remain
a challenge and in this work we explore the potential of runtime
systems for the implementation of a complex and irregular workload
such as a sparse Cholesky solver.
