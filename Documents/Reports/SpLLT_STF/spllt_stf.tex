...
PLASMA~\cite{a.d.d.h.ea:09} software package and because of their
deficiencies in this context they have then been used to implement
sparse algorithm. For example, The \texttt{HSL\_MA87} solver
implements a task-based sparse Cholesky factorization and the
\texttt{qr\_mumps} implements a multifrontal QR method.
