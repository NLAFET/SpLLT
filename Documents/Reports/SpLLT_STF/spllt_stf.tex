...
\begin{figure}[!h]
  \begin{minipage}{0.5\textwidth}
    \centering
    \lstset{basicstyle=\tt\scriptsize, language=C, procnamekeys={}}
    \lstinputlisting{listings/spllt_starpu_facto_task.c}
  ...
  \begin{minipage}{0.5\textwidth}
    ...
    \lstinputlisting{listings/spllt_omp_facto_task.f90}
    \caption{\label{fig:exp-perf}\TODO{put caption}}
  \end{minipage}
\end{figure}
...
\TODO{explain the impact of the latency for the task submission.}

\TODO{explain how tasks are dynamically scheduled.}
...
\TODO{keep table? performance profile?}
