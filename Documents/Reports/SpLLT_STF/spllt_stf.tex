...
remain a challenge and in this work we explore the potential of
runtime systems for the implementation of a complex and irregular
workload such as a sparse Cholesky solver.
